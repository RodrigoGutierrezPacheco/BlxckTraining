...
const Basico1 = () => {
    ...
    <div className='justify'>
        ...
        <p className='red'>*Calentamiento en caminadora/elíptica/bicicleta 10min*</p>
				<p className='red'>todos los ejercicios 3 series de 12-15 repeticiones</p>
				<p className='red'>descanso de 40-60 segundos entre series y ejercicios</p>
        <p>1.- <a onClick={pressMilitarMaquina}>▶️</a>Press militar en máquina</p>
        <p>2.- <a onClick={pressPechoMaquina}>▶️</a> Press de pecho en máquina</p>
        <p>3.- <a onClick={pulldownMaquina}>▶️</a> Pulldown en máquina (espalda)</p>
        <p>4.- <a onClick={curlBicepsMaquina}>▶️</a> Curl de bíceps en máquina</p>
        <p className='red'>*Termina con 10 minutos de caminata ligera*</p>
        <hr />

        <h1 className='red'>Día 2 - Inferior</h1>
        <p className='red'>*Calentamiento en caminadora/elíptica/bicicleta 10min*</p>
        <p>1.- <a onClick={extencionCuadriceps}>▶️</a> Extensión de cuádriceps en máquina</p>
        <p>2.- <a onClick={curlFemoralSentado}>▶️</a> Curl femoral en máquina</p>
        <p>3.- <a onClick={abduccion}>▶️</a> Abducciones en máquina</p>
        <p>4.- <a onClick={adduccion}>▶️</a> Adducciones en máquina</p>
        <p className='red'>*Termina con 10 minutos de caminata ligera*</p>
        <hr />

        <h1 className='red'>Día 3 - Superior</h1>
        <p className='red'>*Calentamiento en caminadora/elíptica/bicicleta 10min*</p>
        <p>1.- <a onClick={remoMaquina}>▶️</a> Remo en máquina</p>
        <p>2.- <a onClick={elevacionesLateralesMancuerna}>▶️</a> Elevaciones laterales con mancuernas</p>
        <p>3.- <a onClick={pressPechoMaquina}>▶️</a> Press de pecho en máquina</p>
        <p>4.- <a onClick={fondosMaquina}>▶️</a> Fondos para tríceps en máquina</p>
        <p className='red'>*Termina con 10 minutos de caminata ligera*</p>
        <hr />

        <h1 className='red'>Día 4 - Inferior</h1>
        <p className='red'>*Calentamiento en caminadora/elíptica/bicicleta 10min*</p>
        <p>1.- <a onClick={prensaCerrada}>▶️</a> Prensa de cuádriceps en máquina</p>
        <p>2.- <a onClick={curlFemoralSentado}>▶️</a> Curl femoral en máquina</p>
        <p>3.- <a onClick={abduccion}>▶️</a> Abducciones en máquina</p>
        <p>4.- <a onClick={adduccion}>▶️</a> Adducciones en máquina</p>
        <p className='red'>*Termina con 10 minutos de caminata ligera*</p>
        ...
        <h1 className='red'>Día 5 - Mixto</h1>
        <p className='red'>*Calentamiento en caminadora/elíptica/bicicleta 10min*</p>
        <p>1.- <a onClick={pressMilitarMaquina}>▶️</a> Press militar en máquina</p>
        <p>2.- <a onClick={pulldownMaquina}>▶️</a> Pulldown en máquina (espalda)</p>
        <p>3.- <a onClick={extencionCuadriceps}>▶️</a> Extensión de cuádriceps en máquina</p>
        <p>4.- <a onClick={curlFemoralSentado}>▶️</a> Curl femoral en máquina</p>
        <p className='red'>*Termina con 10 minutos de caminata ligera*</p>
        <hr />
	...
	<div className='justify'>
				<h1>--Dia 1 Pierna</h1>
				 ...
				 <p className='red'>4 series 10-15 repeticiones, descanso de 1-2 minutos entre series y ejercicios</p>
			...
			<div className='justify'>
				...
				<p>6.-<a onClick={abdomenInferiorMaquina}>▶️</a>abdomen en maquina<a className='red'></a></p>
				<p className='red'>*Termina con programa cardio S8-Principiante-Nivel 1</p>
			</div>
			<hr />
			<div className='justify'>
	...
	{/* <Collapsible open={false} className='dia black1' trigger="Semana 4" triggerWhenOpen="Semana 4" triggerStyle={{fontSize:'5rem'}}>
			...
			<hr />
			<div className='justify'>
				<h1 className='red'>Dia 3 pecho-Triceps-cuadriceps</h1>
				<p className='red'>pesado: 5 series 8-12 reps, movimiento controlado, 2 segundos concentrico 2 segundos excentrico /2 segundos bajada 2 segundos subida / </p>
				<p className='red'>ligero: 4 series 15-20 reps movimientos fluidos</p>
				<p className='red'>Descanso necesario para volver a sacar las mismas repeticiones con el mismo peso</p>
				...
				<p>3.-<a onClick={aperturasMancuernasBancoInclinado}>▶️</a>aperturas en banco inclinado<a className='red'>-ligero</a></p>
				<p>4.-<a onClick={copa2Manos}>▶️</a>copa 2 manos<a className='red'>-pesado</a></p>
				<p>5.-<a onClick={fondosMaquina}>▶️</a>fondos en maquina<a className='red'>-pesado</a></p>
				<p>6.-<a onClick={crunchesPiernasArriba}>▶️</a>crunches en suelo<a className='red'>-ligero</a></p>
				<p className='red'>*Termina con programa cardio S8-Principiante-Nivel 2</p>
			</div>
			<hr />
			<div className='justify'>
				...
				<p className='red'>ligero: 4 series 15-20 reps movimientos fluidos</p>
				<p className='red'>Descanso necesario para volver a sacar las mismas repeticiones con el mismo peso</p>
				 <p>1.-<a onClick={extencionCuadriceps}>▶️</a>extenciones cuadriceps en maquina<a className='red'>-ligero</a></p>
				 <p>2.-<a onClick={curlFemoralSentado}>▶️</a>curl femoral en maquina<a className='red'>-ligero</a></p>
				 <p>3.-<a onClick={sentadillaMancuerna}>▶️</a>sentadilla<a className='red'>-pesado</a></p>
				 <p>4.-<a onClick={desplanteBulgaro}>▶️</a>desplantes bulgaros<a className='red'>-pesado</a></p>
				 <p>5.-<a onClick={pesoMuertoMancuerna}>▶️</a>peso muerto con mancuerna<a className='red'>-pesado</a></p>
				 ...
				 <p>9.-<a onClick={pantorrillaMaquina}>▶️</a>pantorrilla en maquina<a className='red'>-pesado</a></p>
				 <p className='red'>*Termina con programa cardio S8-Principiante-Nivel 3</p>
			</div>
			<hr />
			<div className='justify'>
