    ...
    <div>
      ...
      >
        <div className="justify">
          ...
          <p>
            1.-<a onClick={pressMilitarBarraSentado}>▶️</a>Press Militar con
            barra sentado<a className="red"></a>
          </p>
          <p>
            2.-<a onClick={elevacionesLateralesMancuerna}>▶️</a>Elevaciones
            laterales con mancuernas sentado<a className="red"></a>
          </p>
          <p>
            3.-<a onClick={elevacionesFrontalesMartillo}>▶️</a>elevaciones
            frontales con mancuernas<a className="red"></a>
          </p>
          <p>
            4.-<a onClick={pajaros}>▶️</a>Pajaros con mancuernas
            <a className="red"></a>
          </p>
          <p>
            5.-<a onClick={facepull}>▶️</a>Facepull con polea
            <a className="red"></a>
          </p>
          <p>
            6.-<a onClick={encogimientosHombrosMancuernas}>▶️</a>encogimientos
            con mancuernas<a className="red"></a>
          </p>
          <p>
            7.-<a onClick={curlInvertidoBarra}>▶️</a>curl biceps invertido con
            barra<a className="red"></a>
          </p>
          <p>
            8.-<a onClick={curlAlternado}>▶️</a>curl de biceps alternado
            <a className="red"></a>
          </p>
          <p>
            9.-<a onClick={curlBicepsMartilloMancuerna}>▶️</a>curl martillo
            <a className="red"></a>
          </p>
          <p className="red">
        ...
        <div className="justify">
          ...
          <p>
            4.-<a onClick={extencionCuadriceps}>▶️</a>Extensiones de cuádriceps
            en máquina<a className="red"></a>
          </p>
          <p>
        ...
        <div className="justify">
          ...
          <p>
            ...
            maquina a 1 pierna<a className="red"></a>
          </p>
          <p>
            3.-<a onClick={sentadillaBarra}>▶️</a>sentadilla estricta con
            mancuerna *hasta abajo*<a className="red"></a>
          </p>
          <p>
        ...
        <div className="justify">
          ...
          <p>
            ...
            Laterales con Mancuernas<a className="red"></a>
          </p>
          <p>
          ...
          <p>
            ...
            Martillo Sentado<a className="red"></a>
          </p>
          <p className="red">
            *Termina con programa cardio S8-Principiante-Nivel1
          </p>
        </div>
      </Collapsible>
      {/* Rutina Semana #2  */}
      ...
      >
        <div className="justify">
          ...
          <p className="red">
            pesado: 5 series 8-12 reps movimientos controlados
          </p>
          <p className="red">ligero: 4 series 15-20 reps movimientos fluidos</p>
          <p className="red">
            Descanso necesario para volver a sacar las mismas repeticiones con
            el mismo peso
          </p>
          <p>
            1.-<a onClick={extencionCuadriceps}>▶️</a>extenciones cuadriceps en
            maquina a 1 pierna<a className="red">-ligero</a>
          </p>
          <p>
            2.-<a onClick={curlFemoralSentado}>▶️</a>curl femoral en maquina a 1
            pierna<a className="red">-ligero</a>
          </p>
          <p>
            3.-<a onClick={sentadillaBarra}>▶️</a>sentadilla en smith o barra
            <a className="red">-pesado</a>
          </p>
          <p>
            4.-<a onClick={desplanteBulgaro}>▶️</a>desplantes bulgaros con
            mancuerna<a className="red">-pesado</a>
          </p>
          <p>
            5.-<a onClick={buenosDiasBarra}>▶️</a>buenos dias con barra
            <a className="red">-ligero</a>
          </p>
          <p>
            6.-<a onClick={hipThrust}>▶️</a>hip thrust con barra
            <a className="red">-pesado</a>
          </p>
          <p>
            7.-<a onClick={abduccion}>▶️</a>abducciones en maquina
        ...
        <div className="justify">
          ...
          <p>
            2.-<a onClick={elevacionesLateralesPoleaBaja}>▶️</a>elevaciones
            laterales en polea baja<a className="red">-ligero</a>
          </p>
          <p>
            3.-<a onClick={hombroPosteriorPoleaBaja}>▶️</a>aperturas para
            posterior en polea baja<a className="red">-ligero</a>
          </p>
          <p>
            4.-<a onClick={pressPechoBarraInclinado}>▶️</a>press pecho con barra
            en banco inclinado<a className="red">-pesado</a>
          </p>
          <p>
            5.-<a onClick={aperturasMancuernasBancoInclinado}>▶️</a>aperturas en
            banco inclinado<a className="red">-ligero</a>
          </p>
          <p>
          ...
          <p>
            7.-<a onClick={pressFrancesMancuernas}>▶️</a>press frances con
            mancuernas<a className="red">-pesado</a>
          </p>
          <p>
        ...
        <div className="justify">
          ...
          <p>
            ...
            baja con cuerda<a className="red">-pesado</a>
          </p>
          <p>
            7.-<a onClick={hiperextencionesMaquina}>▶️</a>Hiperextenciones en
            maquina<a className="red">-ligero</a>
          </p>
          <p>
            8.-<a onClick={encogimientosHombrosMancuernas}>▶️</a>Encogimientos
            con mancuernas<a className="red">-pesado</a>
          </p>
          <p className="red">
            *Termina con programa cardio S8-Principiante-Nivel 2
          </p>
        ...
        <div className="justify">
          ...
          <p>
            2.-<a onClick={extencionCuadriceps}>▶️</a>extencion cuadriceps
            maquina a 1 pierna<a className="red">-pesado</a>
          </p>
          <p>
            3.-<a onClick={sentadillaBarra}>▶️</a>sentadilla estricta con
            mancuerna *hasta abajo*<a className="red">-pesado</a>
          </p>
          <p>
            4.-<a onClick={desplantesEstaticos}>▶️</a>desplantes estaticos con
        ...
        <div className="justify">
          ...
          <p className="red">
            5 series 8-12 repeticiones, peso necesario para sacar mismas
            repeticiones en todas las series, descanso lo que sea necesario para
            volver a sacar las mismas reps con mismo peso
          </p>
          <p>
            1.-<a onClick={pressPechoMaquina}>▶️</a>Press pecho en maquina{" "}
            <a className="red"></a>
      ...
      >
        <div className="justify">
          ...
          <p>
            ...
            barra<a className="red"> 4 series de 8-10 reps al 70%-80%</a>
          </p>
          <p>
            2.-<a onClick={prensaCerrada}>▶️</a>prensa para cuadriceps
          ...
          <p>
            4.-<a onClick={desplantesEstaticos}>▶️</a>desplantes estaticos con
            mancuernas<a className="red"> 3 series de 12-15 reps al 60%-70%</a>
          </p>
          <p>
        ...
        <div className="justify">
          ...
          <p className="red">
            ...
            máximo entre series. Percepción de esfuerzo: 7-8/10
          </p>
          <p>
          ...
          <p>
            4.-<a onClick={lagartijasMilitares}>▶️</a> Push-ups o lagartijas
            regulares
          ...
          <p>
            ...
            <a className="red">
              {" "}
              3 series de 10 repeticiones por pierna al 75%
            </a>
          </p>
          <p>
        ...
        <div className="justify">
          ...
          <p>
            3.-<a onClick={elevacionesLateralesMancuerna}>▶️</a>Elevaciones
            Laterales con Mancuernas<a className="red">-ligero</a>
          </p>
          <p>
            4.-<a onClick={fondosMaquina}>▶️</a>Fondos en maquina{" "}
            <a className="red">4 series de 8-10 repeticiones al 80%</a>
      ...
      >
        <div className="justify">
          ...
          <p>
            1.-<a onClick={pressMilitarBarraPie}>▶️</a>press militar de pie con
            barra<a className="red"> 4 series de 8-10 reps al 70%-80%</a>
          </p>
          <p>
            2.-<a onClick={elevacionesLateralesMancuernasSentado}>▶️</a>
            elevaciones laterales en banco
            <a className="red"> 3 series de 12-15 reps al 60%-70%</a>
          </p>
          <p>
            3.-<a onClick={remoMentonBarra}>▶️</a>remo al menton con barra
            <a className="red"> 4 series de 8-10 reps al 70%-80%</a>
          </p>
          <p>
            4.-<a onClick={pressArnoldSentado}>▶️</a>press arnold con mancuernas
            <a className="red"> 3 series de 12-15 reps al 60%-70%</a>
          </p>
          <p>
            5.-<a onClick={patadasMancuernas}>▶️</a>patadas con mancuerna
            <a className="red"> 3 series de 12-15 reps al 60%-70%</a>
          </p>
          <p>
            6.-<a onClick={fondosAsistidos}>▶️</a>fondos maquina asistida
            <a className="red"> 4 series de 8-10 reps al 70%-80%</a>
          </p>
          <p>
            7.-<a onClick={copaUnaMano}>▶️</a>copa 1 mano
            <a className="red"> 4 series de 8-10 reps al 70%-80%</a>
          </p>
          <p>
        ...
        <div className="justify">
          ...
          <p>
            ...
            inclinado<a className="red"> 4 series de 8-10 reps al 70%-80%</a>
          </p>
          <p>
        ...
        <div className="justify">
          ...
          <p>
            ...
            polea<a className="red"> 4 series de 8-10 reps al 70%-80%</a>
          </p>
          <p>
            6.-<a onClick={abdomenInferiorMaquina}>▶️</a>abdomen inferior en
            maquina<a className="red">4 series al fallo</a>
          </p>
          <p className="red">
        ...
        <div className="justify">
          ...
          <p>
            4.-<a onClick={curlBicepsMaquinaScott}>▶️</a>Curl biceps en maquina
            Scott<a className="red"> 3 series de 12-15 reps al 60%-70%</a>
          </p>
          <p>
            5.-<a onClick={prensaSumo}>▶️</a>Prensa, apertura de las piernas
            tipo sumo<a className="red"> 4 series de 8-10 reps al 70%-80%</a>
          </p>
          <p>
            6.-<a onClick={curlFemoralSentado}>▶️</a>Curl Femoral Maquina
            <a className="red"> 4 series de 8-10 reps al 70%-80%</a>
        ...
        <div className="justify">
          ...
          <p>
            ...
            maquina<a className="red"> 4 series de 8-10 reps al 70%-80%</a>
          </p>
          <p>
