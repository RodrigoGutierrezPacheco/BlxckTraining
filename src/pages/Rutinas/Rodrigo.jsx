...
const Rodrigo = () => {
  ...
  function pressPechoBancoPlanoBarra() {
    Swal.fire({
      title: "Press de pecho en banco plano con barra",
      imageUrl: "images/pressPechoBancoPlanoBarra.gif",
      imageWidth: 200,
      imageHeight: 200,
      imageAlt: "Custom image",
      confirmButtonText: "Entendido",
  ...
  function aperturasMancuernasBancoPlano() {
    Swal.fire({
      title: "aperturas con mancuernas en banco plano",
      imageUrl: "images/aperturaMancuernasBancoPlano.gif",
      imageWidth: 200,
      imageHeight: 200,
      imageAlt: "Custom image",
      confirmButtonText: "Entendido",
  ...
  function dominadas() {
    Swal.fire({
      title: "dominadas en maquina",
      imageUrl: "images/dominadas.gif",
      imageWidth: 200,
      imageHeight: 200,
      imageAlt: "Custom image",
      confirmButtonText: "Entendido",
    ...
    <div>
      ...
      >
        ...
        <div className="justify">
          <h1 className="red">Día 1: Pecho y Tríceps</h1>
          <p className="red">
            *Inicia con calentamiento en caminadora/elíptica/bicicleta 10 min*
          </p>

          {/* Ejercicios para el pecho */}
          <p>
            1.-<a onClick={pressPechoBancoPlanoBarra}>▶️</a> Press de banca plano: 4
            series de 6-8 repeticiones al 75-80% de tu 1RM
          </p>
          <p>
            2.-<a onClick={pressPechoInclinadoMancuernas}>▶️</a> Press inclinado con
            mancuernas: 3 series de 8-12 repeticiones al 70% de tu 1RM
          </p>
          <p>
            3.-<a onClick={aperturasMancuernasBancoPlano}>▶️</a> Aperturas planas con
            mancuernas: 3 series de 12-15 repeticiones al 60% de tu 1RM
          </p>

          {/* Ejercicios para tríceps */}
          <p>
            4.-<a onClick={fondosBanco}>▶️</a> Fondos en paralelas: 3 series de 8-10
            repeticiones
          </p>
          <p>
            5.-<a onClick={extencionTricepsPoleaAlta}>▶️</a> Extensiones de tríceps en
            polea alta: 3 series de 12-15 repeticiones
          </p>

          <p className="red">
            *Termina con 15 min de cardio en bicicleta a ritmo ligero*
          </p>
        </div>
        <hr />
        ...
        <div className="justify">
          ...
          <p>
            1.-<a onClick={dominadasAsistidas}>▶️</a> Dominadas: 4 series de 6-8
            repeticiones
          </p>
          <p>
            2.-<a onClick={remoBarra}>▶️</a> Remo con barra: 4 series de 8-10
            repeticiones al 70-75% de tu 1RM
          </p>
          <p>
            3.-<a onClick={pulldownPolea}>▶️</a> Jalón en polea alta: 3 series de
            10-12 repeticiones
          </p>

          {/* Ejercicios para bíceps */}
          <p>
            4.-<a onClick={curlBicepsBarra}>▶️</a> Curl de bíceps con barra: 3
            series de 8-12 repeticiones al 65-70% de tu 1RM
          </p>
          <p>
            5.-<a onClick={curlBicepsMartilloMancuerna}>▶️</a> Curl martillo con mancuernas: 3
            series de 12-15 repeticiones
          </p>

          <p className="red">
            *Termina con 15 min de cardio en caminadora a ritmo moderado*
          </p>
        </div>
        <hr />
        ...
        {/* Día 3: Piernas */}
        <div className="justify">
          <h1 className="red">Día 3: Piernas</h1>
          <p className="red">
            *Inicia con calentamiento en caminadora/elíptica/bicicleta 10 min*
          </p>
          ...
          <p>
            1.-<a onClick={sentadillaBarra}>▶️</a> Sentadilla con barra: 4 series de
            6-8 repeticiones al 75-80% de tu 1RM
          </p>
          <p>
            2.-<a onClick={prensaCerrada}>▶️</a> Prensa de piernas: 4 series de 10-12
            repeticiones
          </p>
          <p>
            3.-<a onClick={curlFemoralSentado}>▶️</a> Curl femoral tumbado: 3 series de
            10-12 repeticiones
          </p>
          <p>
            4.-<a onClick={extencionCuadriceps}>▶️</a> Extensiones de
            cuadriceps: 3 series de 12-15 repeticiones
          </p>
          <p>
            5.-<a onClick={pantorrillaSentadoMancuernas}>▶️</a> Elevaciones de talones: 4 series
        ...
        <div className="justify">
          <h1>Día 4: Hombros y Trapecios</h1>
          <p className="red">
            *Inicia con calentamiento en caminadora/elíptica/bicicleta 10 min*
          </p>
          ...
          <p>
            1.-<a onClick={pressMilitarBarraSentado}>▶️</a> Press militar con barra: 4
            series de 6-8 repeticiones al 70-75% de tu 1RM
          </p>
          <p>
            2.-<a onClick={elevacionesLateralesMancuerna}>▶️</a> Elevaciones laterales
            con mancuernas: 3 series de 12-15 repeticiones
          </p>
          <p>
            3.-<a onClick={elevacionesFrontalesMartillo}>▶️</a> Elevaciones frontales
            con mancuernas: 3 series de 12-15 repeticiones
          </p>

          {/* Ejercicios para trapecios */}
          <p>
            4.-<a onClick={encogimientosBarra}>▶️</a> Encogimientos de hombros
            con barra: 4 series de 10-12 repeticiones
          </p>

          <p className="red">
            *Termina con 15 min de cardio en caminadora a ritmo ligero*
          </p>
        </div>
        <hr />
        ...
        {/* Día 5: Fullbody */}
        <div className="justify">
          <h1 className="red">Día 5: Fullbody</h1>
          <p className="red">
            *Inicia con calentamiento en caminadora/elíptica/bicicleta 10 min*
          </p>
          ...
          {/* Ejercicios Fullbody */}
          <p>
            1.-<a onClick={sentadillaBarra}>▶️</a> Sentadilla con barra: 3
            series de 8 repeticiones al 70% de tu 1RM
          </p>
          <p>
            2.-<a onClick={pressPechoBancoPlanoBarra}>▶️</a> Press de banca plano: 3
            series de 8 repeticiones al 70% de tu 1RM
          </p>
          <p>
            3.-<a onClick={remoBarra}>▶️</a> Remo con barra: 3 series de 8
            repeticiones al 70% de tu 1RM
          </p>
          <p>
            4.-<a onClick={dominadas}>▶️</a> Dominadas: 3 series de 6-8
            repeticiones
          </p>
          <p>
            5.-<a onClick={pressMilitarBarraPie}>▶️</a> Press militar con barra: 3
            series de 8 repeticiones al 70% de tu 1RM
          </p>

          <p className="red">*Termina con 10 min de estiramientos*</p>
        </div>
        <hr />
      </Collapsible>
